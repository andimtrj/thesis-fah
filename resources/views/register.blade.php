  ...
  <div class="flex w-full h-screen bg-custom-gradient font-body">
    <div class="half-background w-full flex justify-center items-center">
      <div class="text-center max-w-xl flex flex-col justify-center items-center">
        <h1 class="text-5xl font-bold text-abu mb-3">Lorem, ipsum!</h1>
        <p class="text-xl text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore, a
          exercitationem.
        </p>
      </div>
    </div>

    <div class="max-w-3xl w-full bg-abu shadow-2xl flex flex-col justify-center">
      ...
      <form class="p-36">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          ...
          <div class="relative z-0 w-full mb-5 group">
            ...
            <label for="floating_company"
              class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Tenant</label>
          </div>
        </div>
        <div class="relative z-0 w-full mb-5 group">
        ...
        <button type="submit"
          class="text-white bg-primary hover:bg-opacity-70 font-medium rounded-2xl w-full text-md px-5 py-3 text-center mb-5">Register</button>
        <p class="text-center text-gray-500">Already have an account? <a href="" class="underline text-primary">Login here</a></p>
      </form>
    </div>
  </div>
