@props(['deleteTitle' => 'Delete Modal', 'deleteDesc' => 'Delete Desc Modal', 'branch'])

<div class="flex items-center">
  <div data-modal-target="deleteModal-{{ $branch->id }}" data-modal-toggle="deleteModal-{{ $branch->id }}"
  ...
  <div id="deleteModal-{{ $branch->id }}" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative bg-white rounded-xl shadow">
        ...
        <div
          ...
          <button type="button"
            ...
            data-modal-toggle="deleteModal-{{ $branch->id }}">
        ...
        <div class="flex flex-col p-4 ">
          <h1 class="text-lg text-black mb-4 text-center"> Are you sure want to delete this branch? <br> This action
            cannot be undone.</h1>
          <form method="POST" action="{{ route('delete-branch', ['id' => $branch->id]) }}" class="flex gap-4 w-full">
            @csrf
            <a data-modal-toggle="deleteModal-{{ $branch->id }}"
