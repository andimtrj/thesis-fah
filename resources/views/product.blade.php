  ...
  <x-sidebar.sidebar>
    ...
    <div class="flex items-end gap-5 px-10 bg-white mt-5">
      <div class="flex gap-5">
        <div class="w-[15vw]">
          <label for="small-input" class="block mb-1 text-sm font-medium text-gray-900">Search Filter 1</label>
        ...
        <div class="w-[15vw]">
          <label for="small-input" class="block mb-1 text-sm font-medium text-gray-900">Search Filter 2</label>
          <input type="text" id="small-input"
            class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-primary focus:border-primary"
            placeholder="Search by">
        </div>
