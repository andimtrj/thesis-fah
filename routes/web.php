...
Route::middleware('web')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/add-branch', function () {return view('components.branch.add-branch');})->name('add-branch');
        Route::get('/edit-branch', function () {return view('components.branch.edit-branch');})->name('edit-branch');
