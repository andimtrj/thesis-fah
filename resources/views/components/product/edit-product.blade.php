<x-master>
                ...
                <tr class="bg-white border-y text-base text-abu">
                  <td class="px-2 py-3">
                    <input type="text" id="small-input" name="ingredients[0][name]"
                      ...
                      placeholder="Current ingredient name">
                  </td>
                  ...
                  <td class="px-2">
                    <select id="metrics" name="ingredients[${rowCount}][metric_code]"
                      class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-primary">
                      <option value="" disabled selected>Current ingredient metrics</option>
                    </select>
                  </td>
  ...
  <script>
    ...
    const allProductCategories =
      @json($productCategories ?? []); // Provide a default empty array if $metrics is not available
    ...
    document.getElementById('branches').addEventListener('change', function(event) {
      ...
      const filteredProductCategories = allProductCategories.filter(productCategory => productCategory.branch_id ==
        selectedBranch[0].id);
