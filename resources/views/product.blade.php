    ...
    <div class="shadow-md">
      <div class="flex justify-between gap-3 items-center px-10 py-5 bg-primary rounded-t-xl">
        ...
        <div class="flex gap-3">
          <a href="" class="flex items-center text-white bg-accent lg:px-3 md:px-1 py-2 rounded-lg gap-1 flex-shrink-0 shadow-container w-fit md:text-xs lg:text-base">
      ...
      <div class="flex items-end gap-5 px-10 bg-white pt-5">
        <form action="" method="GET" class="flex gap-5 mb-5">
          <div class="w-[15vw]">
            <label for="branchCode" class="block mb-1 text-sm font-medium text-gray-900">Product code</label>
          ...
          <div class="w-[15vw]">
            <label for="branchName" class="block mb-1 text-sm font-medium text-gray-900">Product name</label>
