    ...
    <x-sidebar.sidebar>
      <div class="shadow-xl rounded-xl">
        <div class="px-10 py-5 bg-primary text-white rounded-t-xl">
          <h1 class="text-3xl font-medium">Add Adjustment</h1>
        </div>
        <div class="px-10 py-7 rounded-xl bg-white">
          <h2 class="text-xl font-medium mb-5 border-b-abu border-b-2">Adjustment Details</h2>
          <form action="{{ route('insert-adjustment') }}" method="POST">
            @csrf
